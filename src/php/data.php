                        ...
                        <form action="" method="post">
                            ...
                            <!-- F R O M (PONER NAME A SELECT Y VALUE A OPTION)-->
                                <select name='from_unit' class="conversor__data-cantidades" value='from_unit'>
                                    <option name="" selected>Unidades</option>
                                    <option name='1-'>Bytes</option>
                                    <option name='2-'>Kilobytes</option>
                                    <option name='3-'>Megabytes</option>
                                    <option name='4-'>Gigabytes</option>
                                    <option name='5-'>Terabytes</option>
                                </select>
                            </div>
                            ...
                            <div class="conversor__options-container">
                                ...
                                <select name='to_unit' class="conversor__options-cantidades" value='to_unit'>
                                    <option name="" selected>Unidades</option>
                                    <option name='Bytes'>Bytes</option>
                                    <option name='Kilobytes'>Kilobytes</option>
                                    <option name='Megabytes'>Megabytes</option>
                                    <option name='Gigabytes'>Gigabytes</option>
                                    <option name='Terabytes'>Terabytes</option>
                                </select>
                            </div>
